...
var AuthorList = function () { return (React.createElement(_1.List, null,
    React.createElement(_1.DataTable, { rowClick: false },
        React.createElement(_1.DataTable.Col, { source: "id" }),
        React.createElement(_1.DataTable.Col, { source: "firstName" }),
        React.createElement(_1.DataTable.Col, { source: "lastName" }),
        React.createElement(_1.DataTable.Col, null,
...
var BookList = function () {
    ...
    return (React.createElement(_1.List, { resource: "books", filter: { authorId: authorId } },
        React.createElement(_1.DataTable, { rowClick: "edit" },
            React.createElement(_1.DataTable.Col, { source: "id" }),
            React.createElement(_1.DataTable.Col, { source: "title" }),
            React.createElement(_1.DataTable.Col, { source: "year" }))));
};
