...
var useLogout_1 = __importDefault(require("../auth/useLogout.cjs"));
var usePermissions_1 = __importDefault(require("../auth/usePermissions.cjs"));
var useResourceDefinitionContext_1 = require("./useResourceDefinitionContext.cjs");
/**
