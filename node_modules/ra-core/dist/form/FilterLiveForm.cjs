...
var cloneDeep_js_1 = __importDefault(require("lodash/cloneDeep.js"));
var get_js_1 = __importDefault(require("lodash/get.js"));
var mergeWith_js_1 = __importDefault(require("lodash/mergeWith.js"));
...
var validation_1 = require("./validation/index.cjs");
        ...
        var unsubscribe = watch(function (values, _a) {
            ...
            if (name) {
                if ((0, get_js_1.default)(values, name) === '') {
                    var newValues = (0, cloneDeep_js_1.default)(values);
...
var mergeObjNotArray = function (a, b) {
    return (0, mergeWith_js_1.default)((0, cloneDeep_js_1.default)(a), b, mergeCustomizer);
};
/**
