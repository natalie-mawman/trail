...
var groups_1 = require("./groups/index.cjs");
var useApplyInputDefaultValues_1 = require("./useApplyInputDefaultValues.cjs");
...
var useInput = function (props) {
    ...
    var _c = (0, react_hook_form_1.useController)(__assign({ name: finalName, defaultValue: (0, get_js_1.default)(record, finalSource, defaultValue), rules: {
