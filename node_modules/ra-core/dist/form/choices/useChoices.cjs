...
var useChoices = function (_a) {
    ...
    var getChoiceValue = (0, react_1.useCallback)(function (choice) { return (0, get_js_1.default)(choice, optionValue, (0, get_js_1.default)(choice, 'id')); }, [optionValue]);
    var getDisableValue = (0, react_1.useCallback)(function (choice) { return (0, get_js_1.default)(choice, disableValue); }, [disableValue]);
    return {
