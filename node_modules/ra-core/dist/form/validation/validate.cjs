...
var memoize_js_1 = __importDefault(require("lodash/memoize.js"));
...
var memoize = function (fn) {
    return (0, memoize_js_1.default)(fn, function () {
        var args = [];
 ...
 */
exports.regex = (0, memoize_js_1.default)(function (pattern, message) {
