...
var SimpleList = function (_a) {
    ...
    return (React.createElement(__1.WithListContext, { render: function (_a) {
            ...
            return isPending ? null : children ? (children) : (React.createElement("ul", { style: {
                ...
                } }, data === null || data === void 0 ? void 0 : data.map(function (record) { return (React.createElement(__1.RecordContextProvider, { key: record.id, value: record },
