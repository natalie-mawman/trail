...
export var ReferenceManyCountBase = function (props) {
    ...
    var _b = useReferenceManyFieldController(__assign(__assign({}, rest), { page: 1, perPage: 1 })), isPaused = _b.isPaused, isPending = _b.isPending, fetchError = _b.error, total = _b.total;
