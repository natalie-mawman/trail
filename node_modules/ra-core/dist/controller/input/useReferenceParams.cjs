...
var useReferenceParams = function (_a) {
    ...
    var changeParams = (0, react_1.useCallback)(function (action) {
        if (!tempParams.current) {
            ...
            var newTempParams_1 = (0, list_1.queryReducer)(query, action);
    ...
    var debouncedSetFilters = (0, react_1.useRef)((0, debounce_js_1.default)(function (filter, displayedFilters) {
