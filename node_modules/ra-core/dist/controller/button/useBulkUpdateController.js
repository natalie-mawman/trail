...
import { useUpdateMany, } from "../../dataProvider/useUpdateMany.js";
export var useBulkUpdateController = function (props) {
    ...
    var _d = useUpdateMany(resource, undefined, __assign({ onSuccess: onSuccess !== null && onSuccess !== void 0 ? onSuccess : (function () {
