...
var useGetList = function (resource, params, options) {
    ...
    var result = (0, react_query_1.useQuery)(__assign({ queryKey: [resource, 'getList', { pagination: pagination, sort: sort, filter: filter, meta: meta }], queryFn: function (queryParams) {
            return dataProvider
                .getList(resource, {
