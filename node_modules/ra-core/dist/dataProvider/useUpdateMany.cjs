...
var useDataProvider_1 = require("./useDataProvider.cjs");
var useMutationWithMutationMode_1 = require("./useMutationWithMutationMode.cjs");
...
var useUpdateMany = function (resource, params, options) {
    ...
    var _b = (0, useMutationWithMutationMode_1.useMutationWithMutationMode)(__assign({ resource: resource }, params), __assign(__assign({}, mutationOptions), { mutationKey: [resource, 'updateMany', params], mutationMode: mutationMode, mutationFn: function (_a) {
            ...
            if (getMutateWithMiddlewares) {
                ...
                var mutateWithMiddlewares_1 = getMutateWithMiddlewares(dataProviderUpdateMany.bind(dataProvider));
