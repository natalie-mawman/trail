...
var unset_js_1 = __importDefault(require("lodash/unset.js"));
...
var memoryStore = function (storage) {
    ...
    return {
        ...
        getItem: function (key, defaultValue) {
            return (0, get_js_1.default)(storage, key, defaultValue);
        },
        setItem: function (key, value) {
            (0, set_js_1.default)(storage, key, value);
            publish(key, value);
        },
        removeItem: function (key) {
            (0, unset_js_1.default)(storage, key);
