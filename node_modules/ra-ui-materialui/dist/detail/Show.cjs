...
var ShowView_1 = require("./ShowView.cjs");
...
var Show = function (inProps) {
    ...
    var id = props.id, resource = props.resource, queryOptions = props.queryOptions, disableAuthentication = props.disableAuthentication, _a = props.authLoading, authLoading = _a === void 0 ? defaultAuthLoading : _a, loading = props.loading, error = props.error, rest = __rest(props, ["id", "resource", "queryOptions", "disableAuthentication", "authLoading", "loading", "error"]);
    if (!props.render && !props.children) {
        throw new Error('<Show> requires either a `render` prop or `children` prop');
    }
    return (React.createElement(ra_core_1.ShowBase, { id: id, disableAuthentication: disableAuthentication, queryOptions: queryOptions, resource: resource, authLoading: authLoading, loading: loading, 
        ...
        offline: false },
        React.createElement(ShowView_1.ShowView, __assign({ error: error }, rest))));
};
exports.Show = Show;
