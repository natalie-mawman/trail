...
var CreateActions = function (props) {
    var hasList = (0, ra_core_1.useResourceDefinition)(props).hasList;
    return (React.createElement(TopToolbar_1.default, __assign({}, sanitizeRestProps(props)), hasList && React.createElement(button_1.ListButton, null)));
};
