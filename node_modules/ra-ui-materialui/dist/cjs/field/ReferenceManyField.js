...
var ReferenceManyField = function (props) {
    ...
    return (react_1.default.createElement(ra_core_1.ReferenceManyFieldBase, __assign({}, controllerProps, { empty: typeof empty === 'string' ? (react_1.default.createElement(material_1.Typography, { component: "span", variant: "body2" }, translate(empty, { _: empty }))) : (empty), render: function (props) {
