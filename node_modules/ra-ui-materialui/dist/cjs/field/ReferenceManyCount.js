...
var ReferenceManyCount = function (inProps) {
    ...
    var className = props.className, reference = props.reference, target = props.target, filter = props.filter, sort = props.sort, link = props.link, resource = props.resource, _b = props.source, source = _b === void 0 ? 'id' : _b, _c = props.offline, offline = _c === void 0 ? defaultOffline : _c, rest = __rest(props, ["className", "reference", "target", "filter", "sort", "link", "resource", "source", "offline"]);
    var record = (0, ra_core_1.useRecordContext)(props);
    var createPath = (0, ra_core_1.useCreatePath)();
    var body = (react_1.default.createElement(ra_core_1.ReferenceManyCountBase, __assign({}, props, { loading: react_1.default.createElement(material_1.CircularProgress, { size: 14 }), error: react_1.default.createElement(Error_1.default, { color: "error", fontSize: "small", titleAccess: "error" }), offline: offline })));
