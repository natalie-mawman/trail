...
exports.SimpleFormIteratorItem = React.forwardRef(function (props, ref) {
    ...
    var _c = (0, ra_core_1.useSimpleFormIterator)(), total = _c.total, reOrder = _c.reOrder, remove = _c.remove;
    ...
    return (React.createElement(ra_core_1.SimpleFormIteratorItemContext.Provider, { value: context },
