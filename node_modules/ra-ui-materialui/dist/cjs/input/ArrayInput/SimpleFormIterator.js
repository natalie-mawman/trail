...
var SimpleFormIterator = function (inProps) {
    ...
    var _f = (0, ra_core_1.useArrayInput)(props), append = _f.append, fields = _f.fields, move = _f.move, remove = _f.remove, replace = _f.replace;
    var _g = (0, react_hook_form_1.useFormContext)(), trigger = _g.trigger, getValues = _g.getValues;
    ...
    return fields ? (React.createElement(ra_core_1.SimpleFormIteratorContext.Provider, { value: context },
