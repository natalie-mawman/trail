...
var ReOrderButtons = function (_a) {
    ...
    var _b = (0, ra_core_1.useSimpleFormIteratorItem)(), index = _b.index, total = _b.total, reOrder = _b.reOrder;
    var source = (0, ra_core_1.useSimpleFormIterator)().source;
    return (React.createElement("span", { className: (0, clsx_1.default)("button-reorder button-reorder-".concat(source, "-").concat(index), className) },
