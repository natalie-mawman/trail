 ...
 * );
 */
var DatagridInput = function (inProps) {
    var _a;
    ...
    var _d = (0, ra_core_1.useInput)(__assign(__assign(__assign({}, props), choicesContext), { source: source })), field = _d.field, fieldState = _d.fieldState;
    ...
    var listContext = React.useMemo(function () { return (__assign(__assign({}, choicesContext), { data: availableChoices, total: availableChoices === null || availableChoices === void 0 ? void 0 : availableChoices.length, error: null, onSelect: onSelect, onToggleItem: onToggleItem, onUnselectItems: onUnselectItems, selectedIds: field.value })); }, [
        availableChoices,
        choicesContext,
        field,
        onSelect,
    ...
    return (React.createElement(Root, { className: (0, clsx_1.default)('ra-input', "ra-input-".concat(source), className) },
        React.createElement(ra_core_1.ListContextProvider, { value: listContext },
            filters ? (Array.isArray(filters) ? (React.createElement(ra_core_1.FilterContext.Provider, { value: filters },
                React.createElement(React.Fragment, null,
                    React.createElement(list_1.FilterForm, null),
                    React.createElement(list_1.FilterButton, null)))) : (React.createElement(React.Fragment, null,
            ...
            !fieldState.error && !fetchError && (React.createElement(React.Fragment, null,
                React.createElement(list_1.Datagrid, __assign({}, (0, sanitizeInputRestProps_1.sanitizeInputRestProps)(rest))),
                pagination !== false && pagination)),
            React.createElement(InputHelperText_1.InputHelperText, { error: ((_a = fieldState.error) === null || _a === void 0 ? void 0 : _a.message) || (fetchError === null || fetchError === void 0 ? void 0 : fetchError.message) }))));
};
exports.DatagridInput = DatagridInput;
var PREFIX = 'RaDatagridInput';
