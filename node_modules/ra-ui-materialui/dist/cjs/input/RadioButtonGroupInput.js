...
var RadioButtonGroupInput = function (inProps) {
    ...
    var _f = (0, ra_core_1.useChoicesContext)({
        ...
        source: sourceProp,
    }), allChoices = _f.allChoices, isPending = _f.isPending, fetchError = _f.error, resource = _f.resource, source = _f.source, isFromReference = _f.isFromReference;
    if (source === undefined) {
    ...
    var _g = (0, ra_core_1.useInput)(__assign({ format: format, onBlur: onBlur, onChange: onChange, parse: parse, resource: resource, source: source, validate: validate, disabled: disabled, readOnly: readOnly }, rest)), id = _g.id, isRequired = _g.isRequired, fieldState = _g.fieldState, field = _g.field;
