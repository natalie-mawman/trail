...
exports.Datagrid = React.forwardRef(function (inProps, ref) {
    ...
    var _a = props.optimized, optimized = _a === void 0 ? false : _a, _b = props.body, body = _b === void 0 ? optimized ? DatagridBody_1.PureDatagridBody : DatagridBody_1.default : _b, _c = props.header, header = _c === void 0 ? DatagridHeader_1.DatagridHeader : _c, children = props.children, className = props.className, empty = props.empty, expand = props.expand, bulkActionsToolbar = props.bulkActionsToolbar, _d = props.bulkActionButtons, bulkActionButtons = _d === void 0 ? canDelete ? defaultBulkActionButtons : false : _d, hover = props.hover, isRowSelectable = props.isRowSelectable, isRowExpandable = props.isRowExpandable, resource = props.resource, rowClick = props.rowClick, rowSx = props.rowSx, rowStyle = props.rowStyle, _e = props.size, size = _e === void 0 ? 'small' : _e, sx = props.sx, _f = props.expandSingle, expandSingle = _f === void 0 ? false : _f, rest = __rest(props, ["optimized", "body", "header", "children", "className", "empty", "expand", "bulkActionsToolbar", "bulkActionButtons", "hover", "isRowSelectable", "isRowExpandable", "resource", "rowClick", "rowSx", "rowStyle", "size", "sx", "expandSingle"]);
    var _g = (0, ra_core_1.useListContextWithProps)(props), sort = _g.sort, data = _g.data, isPending = _g.isPending, onSelect = _g.onSelect, onToggleItem = _g.onToggleItem, selectedIds = _g.selectedIds, setSort = _g.setSort, total = _g.total;
    ...
    if (data == null || data.length === 0 || total === 0) {
        return empty === undefined ? (React.createElement(ListNoResults_1.ListNoResults, { resource: resource })) : (empty);
    }
    /**
