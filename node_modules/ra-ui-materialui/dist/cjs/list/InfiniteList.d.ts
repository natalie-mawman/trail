 ...
 * );
 */
export declare const InfiniteList: <RecordType extends RaRecord = any>(props: InfiniteListProps<RecordType>) => ReactElement;
export interface InfiniteListProps<RecordType extends RaRecord = any> extends Omit<InfiniteListBaseProps<RecordType>, 'children' | 'render'>, ListViewProps {
}
