...
exports.DataTable = React.forwardRef(function DataTable(inProps, ref) {
    ...
    return (React.createElement(ra_core_1.DataTableBase, __assign({}, props, { hasBulkActions: hasBulkActions, loading: loading, empty: empty === undefined ? (React.createElement(ListNoResults_1.ListNoResults, { resource: resourceFromContext })) : (empty) }),
