...
var ColumnsSelectorItem = function (_a) {
    ...
    return isColumnFiltered ? (React.createElement(preferences_1.FieldToggle, { key: columnRank, source: source, label: fieldLabel, index: String(columnRank), selected: !isColumnHidden, onToggle: function () {
