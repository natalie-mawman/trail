...
var ToggleThemeButton = function () {
    ...
    return (react_1.default.createElement(material_1.Tooltip, { title: toggleThemeTitle, enterDelay: 300 },
        react_1.default.createElement(StyledIconButton, __assign({ color: "inherit", onClick: handleTogglePaletteType, "aria-label": toggleThemeTitle }, props), theme === 'dark' ? react_1.default.createElement(Brightness7_1.default, null) : react_1.default.createElement(Brightness4_1.default, null))));
};
exports.ToggleThemeButton = ToggleThemeButton;
var PREFIX = 'RaToggleThemeButton';
