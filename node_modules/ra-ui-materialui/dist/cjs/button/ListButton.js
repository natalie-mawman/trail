 ...
 * );
 */
var ListButton = function (inProps) {
    ...
    return (React.createElement(StyledButton, __assign({ component: react_router_dom_1.Link, to: createPath({ type: 'list', resource: resource }), state: scrollStates[String(scrollToTop)], 
