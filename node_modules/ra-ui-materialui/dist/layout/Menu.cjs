...
var DashboardMenuItem_1 = require("./DashboardMenuItem.cjs");
var MenuItemLink_1 = require("./MenuItemLink.cjs");
var ResourceMenuItem_1 = require("./ResourceMenuItem.cjs");
var ResourceMenuItems_1 = require("./ResourceMenuItems.cjs");
...
var Root = (0, styles_1.styled)(material_1.MenuList, {
    ...
    return (_b = {
        ...
        _b["&.".concat(exports.MenuClasses.open)] = {
            width: (0, get_js_1.default)(theme, 'sidebar.width', Sidebar_1.DRAWER_WIDTH),
        },
        _b["&.".concat(exports.MenuClasses.closed)] = {
            width: (0, get_js_1.default)(theme, 'sidebar.closedWidth', Sidebar_1.CLOSED_DRAWER_WIDTH),
        },
        _b);
});
