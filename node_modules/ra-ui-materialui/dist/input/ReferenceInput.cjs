...
var AutocompleteInput_1 = require("./AutocompleteInput.cjs");
/**
...
var ReferenceInput = function (props) {
    ...
    return (react_1.default.createElement(ra_core_1.ReferenceInputBase, __assign({}, rest, { offline: offline }), children));
};
