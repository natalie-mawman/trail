...
import { FilterContext, ListContextProvider, useChoicesContext, useInput, } from 'ra-core';
import { styled, useThemeProps, } from '@mui/material/styles';
import { InputHelperText } from "./InputHelperText.js";
import { Datagrid, FilterButton, FilterForm } from "../list/index.js";
import { Pagination as DefaultPagination } from "../list/pagination/index.js";
 ...
 * );
 */
export var DatagridInput = function (inProps) {
    var _a;
    ...
    var _d = useInput(__assign(__assign(__assign({}, props), choicesContext), { source: source })), field = _d.field, fieldState = _d.fieldState;
    ...
    return (React.createElement(Root, { className: clsx('ra-input', "ra-input-".concat(source), className) },
        React.createElement(ListContextProvider, { value: listContext },
            ...
            !fieldState.error && !fetchError && (React.createElement(React.Fragment, null,
                React.createElement(Datagrid, __assign({}, sanitizeInputRestProps(rest))),
                pagination !== false && pagination)),
            React.createElement(InputHelperText, { error: ((_a = fieldState.error) === null || _a === void 0 ? void 0 : _a.message) || (fetchError === null || fetchError === void 0 ? void 0 : fetchError.message) }))));
};
