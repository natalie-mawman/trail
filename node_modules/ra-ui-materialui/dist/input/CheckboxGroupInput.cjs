...
var CheckboxGroupInputItem_1 = require("./CheckboxGroupInputItem.cjs");
...
var CheckboxGroupInput = function (inProps) {
    ...
    var handleCheck = (0, react_1.useCallback)(function (event, isChecked) {
        var newValue;
        if (allChoices &&
            allChoices.every(function (item) { return typeof (0, get_js_1.default)(item, optionValue) === 'number'; })) {
            try {
    ...
    return (React.createElement(StyledFormControl, __assign({ component: "fieldset", margin: margin, error: fetchError || invalid, className: (0, clsx_1.default)('ra-input', "ra-input-".concat(source), className) }, sanitizeRestProps(rest)),
        ...
        React.createElement(material_1.FormGroup, { row: row }, allChoices === null || allChoices === void 0 ? void 0 : allChoices.map(function (choice, index) { return (React.createElement(CheckboxGroupInputItem_1.CheckboxGroupInputItem, __assign({ key: (0, get_js_1.default)(choice, optionValue), choice: choice, id: id, onChange: handleCheck, options: options, optionText: optionText !== null && optionText !== void 0 ? optionText : (isFromReference ? getRecordRepresentation : 'name'), optionValue: optionValue, translateChoice: translateChoice !== null && translateChoice !== void 0 ? translateChoice : !isFromReference, value: value, labelPlacement: labelPlacement, inputRef: index === 0 ? ref : undefined, disableValue: disableValue, disabled: disabled || readOnly, readOnly: readOnly }, sanitizeRestProps(rest)))); })),
