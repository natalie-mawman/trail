...
var ArrayInput = function (inProps) {
    ...
    var className = props.className, _c = props.defaultValue, defaultValue = _c === void 0 ? [] : _c, label = props.label, children = props.children, helperText = props.helperText, isPending = props.isPending, resourceFromProps = props.resource, arraySource = props.source, validate = props.validate, variant = props.variant, _d = props.margin, margin = _d === void 0 ? 'dense' : _d, rest = __rest(props, ["className", "defaultValue", "label", "children", "helperText", "isPending", "resource", "source", "validate", "variant", "margin"]);
    var parentSourceContext = (0, ra_core_1.useSourceContext)();
    var finalSource = parentSourceContext.getSource(arraySource);
    var _e = (0, react_hook_form_1.useFormContext)(), getFieldState = _e.getFieldState, formState = _e.formState;
    ...
    return (React.createElement(Root, __assign({ fullWidth: true, margin: margin, className: (0, clsx_1.default)('ra-input', "ra-input-".concat(finalSource), exports.ArrayInputClasses.root, className), error: !!error }, (0, sanitizeInputRestProps_1.sanitizeInputRestProps)(rest)),
        ...
        React.createElement(ra_core_1.ArrayInputBase, __assign({}, props, { defaultValue: defaultValue }), children),
