...
import { IconButtonWithTooltip } from "../../button/index.js";
export var ReOrderButtons = function (_a) {
    ...
    return (React.createElement("span", { className: clsx("button-reorder button-reorder-".concat(source, "-").concat(index), className) },
