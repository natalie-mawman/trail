...
export var EditView = function (props) {
    var _a;
    var actions = props.actions, aside = props.aside, children = props.children, render = props.render, className = props.className, _b = props.component, Content = _b === void 0 ? Card : _b, _c = props.emptyWhileLoading, emptyWhileLoading = _c === void 0 ? false : _c, _d = props.offline, offline = _d === void 0 ? defaultOffline : _d, error = props.error, title = props.title, rest = __rest(props, ["actions", "aside", "children", "render", "className", "component", "emptyWhileLoading", "offline", "error", "title"]);
