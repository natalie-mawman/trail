...
export var CreateView = function (props) {
    var _a;
    var actions = props.actions, aside = props.aside, children = props.children, render = props.render, className = props.className, _b = props.component, Content = _b === void 0 ? Card : _b, title = props.title, rest = __rest(props, ["actions", "aside", "children", "render", "className", "component", "title"]);
    var createContext = useCreateContext();
    ...
    return (React.createElement(Root, __assign({ className: clsx('create-page', className) }, rest),
        ...
        React.createElement("div", { className: clsx(CreateClasses.main, (_a = {},
                ...
                _a)) },
            React.createElement(Content, { className: CreateClasses.card }, render ? render(createContext) : children),
            aside)));
};
var PREFIX = 'RaCreate';
