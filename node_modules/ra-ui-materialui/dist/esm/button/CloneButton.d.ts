...
export declare const CloneButton: (inProps: CloneButtonProps) => React.JSX.Element;
interface Props {
    record?: any;
    icon?: ReactNode;
    scrollToTop?: boolean;
...
declare const _default: React.MemoExoticComponent<(inProps: CloneButtonProps) => React.JSX.Element>;
