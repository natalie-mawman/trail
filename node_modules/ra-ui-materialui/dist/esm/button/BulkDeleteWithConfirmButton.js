...
export var BulkDeleteWithConfirmButton = function (inProps) {
    ...
    var _g = useBulkDeleteController(__assign(__assign({ mutationMode: mutationMode }, rest), { mutationOptions: __assign(__assign({}, rest.mutationOptions), { onSettled: function () {
                var _a, _b;
                var args = [];
