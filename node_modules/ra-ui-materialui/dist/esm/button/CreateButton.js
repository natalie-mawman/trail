...
import { useCreatePath, useCanAccess, useGetResourceLabel, useResourceContext, useResourceTranslation, } from 'ra-core';
...
var CreateButton = function (inProps) {
    ...
    return isSmall ? (React.createElement(StyledFab, __assign({ component: Link, to: createPath({ resource: resource, type: 'create' }), state: state, 
        ...
        color: "primary", className: clsx(CreateButtonClasses.floating, className), "aria-label": typeof label === 'string' ? label : undefined }, rest, linkParams), icon)) : (React.createElement(StyledButton, __assign({ component: Link, to: createPath({ resource: resource, type: 'create' }), state: state, className: clsx(CreateButtonClasses.root, className), 
