...
export var ToggleThemeButton = function () {
    ...
    return (React.createElement(Tooltip, { title: toggleThemeTitle, enterDelay: 300 },
        React.createElement(StyledIconButton, __assign({ color: "inherit", onClick: handleTogglePaletteType, "aria-label": toggleThemeTitle }, props), theme === 'dark' ? React.createElement(Brightness7Icon, null) : React.createElement(Brightness4Icon, null))));
};
