 ...
 * );
 */
export declare const List: <RecordType extends RaRecord = any>(props: ListProps<RecordType>) => ReactElement;
export interface ListProps<RecordType extends RaRecord = any> extends Omit<ListBaseProps<RecordType>, 'children' | 'render'>, ListViewProps {
}
