...
export var ListView = function (props) {
    ...
    var renderList = function () {
        var _a;
        return (React.createElement("div", { className: clsx(ListClasses.main, (_a = {},
                _a[ListClasses.noActions] = !(filters || actions) || showOffline || showError,
                _a)) },
...
var Root = styled('div', {
    ...
    return (_b = {
        ...
        _b["& .".concat(ListClasses.content)] = (_c = {
            ...
            _c.overflow = 'inherit',
            _c),
        _b["& .".concat(ListClasses.noActions)] = {
            marginTop: '1em',
        },
