...
export var ReferenceManyCount = function (inProps) {
    ...
    var body = (React.createElement(ReferenceManyCountBase, __assign({}, props, { loading: React.createElement(CircularProgress, { size: 14 }), error: React.createElement(ErrorIcon, { color: "error", fontSize: "small", titleAccess: "error" }), offline: offline })));
