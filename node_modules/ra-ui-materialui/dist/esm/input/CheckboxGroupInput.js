...
export var CheckboxGroupInput = function (inProps) {
    ...
    var _f = useInput(__assign({ format: format, parse: parse, resource: resource, source: source, validate: validate, onChange: onChange, onBlur: onBlur, disabled: disabled, readOnly: readOnly }, rest)), _g = _f.field, formOnChange = _g.onChange, formOnBlur = _g.onBlur, value = _g.value, ref = _g.ref, _h = _f.fieldState, error = _h.error, invalid = _h.invalid, id = _f.id, isRequired = _f.isRequired;
