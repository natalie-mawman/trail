...
export var RadioButtonGroupInput = function (inProps) {
    ...
    var _g = useInput(__assign({ format: format, onBlur: onBlur, onChange: onChange, parse: parse, resource: resource, source: source, validate: validate, disabled: disabled, readOnly: readOnly }, rest)), id = _g.id, isRequired = _g.isRequired, fieldState = _g.fieldState, field = _g.field;
