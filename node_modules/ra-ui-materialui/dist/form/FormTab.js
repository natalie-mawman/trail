...
export var FormTab = function (props) {
    ...
    var renderContent = function () { return (React.createElement(FormGroupContextProvider, { name: value.toString() },
        React.createElement(Stack, __assign({ style: hidden ? hiddenStyle : undefined, className: contentClassName, id: "tabpanel-".concat(value), "aria-labelledby": "tabheader-".concat(value), "aria-hidden": hidden || undefined }, rest, { sx: __spreadArray([
                {
