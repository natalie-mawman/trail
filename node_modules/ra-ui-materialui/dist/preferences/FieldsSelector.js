...
export var FieldsSelector = function (_a) {
    ...
    return (React.createElement(Box, { sx: {
        ...
        React.createElement(Box, { component: "ul", sx: { paddingInlineStart: 0, m: 0 } }, availableFields.map(function (field) { return (React.createElement(FieldToggle, { key: field.index, source: field.source, label: field.label, index: field.index, selected: fields.includes(field.index), onToggle: handleToggle, onMove: handleMove })); })),
        React.createElement(Box, { onDrop: function (e) { return e.preventDefault(); }, sx: {
                display: 'flex',
