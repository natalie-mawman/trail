...
var matches_js_1 = __importDefault(require("lodash/matches.js"));
var pickBy_js_1 = __importDefault(require("lodash/pickBy.js"));
...
var DefaultIsSelected = function (value, filters) {
    return (0, matches_js_1.default)((0, pickBy_js_1.default)(value, function (val) { return typeof val !== 'undefined'; }))(filters);
};
var DefaultToggleFilter = function (value, filters) {
    var isSelected = (0, matches_js_1.default)((0, pickBy_js_1.default)(value, function (val) { return typeof val !== 'undefined'; }))(filters);
    if (isSelected) {
