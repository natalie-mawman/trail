...
var FilterFormInput_1 = require("./FilterFormInput.cjs");
var FilterForm = function (inProps) {
    ...
    var filters = (0, ra_core_1.useFilterContext)() || filtersProps;
...
var FilterFormBase = function (props) {
    ...
    var getShownFilters = function () {
        ...
        return filters.filter(function (filterElement) {
            var filterValue = (0, get_js_1.default)(values, filterElement.props.source);
