...
var SimpleListLoading_1 = require("./SimpleListLoading.cjs");
var SimpleListItem_1 = require("./SimpleListItem.cjs");
/**
 ...
 * );
 */
var SimpleList = function (inProps) {
    ...
    return (React.createElement(ra_core_1.WithListContext, __assign({}, props, { loading: React.createElement(SimpleListLoading_1.SimpleListLoading, { className: className, hasLeftAvatarOrIcon: !!leftIcon || !!leftAvatar, hasRightAvatarOrIcon: !!rightIcon || !!rightAvatar, hasSecondaryText: !!secondaryText, hasTertiaryText: !!tertiaryText }), empty: empty !== null && empty !== void 0 ? empty : null, 
        // We need to keep passing data explicitly as it may have been passed down through props.
        render: function (_a) {
            var data = _a.data;
            return (React.createElement(Root, __assign({ className: className }, (0, ra_core_1.sanitizeListRestProps)(rest)),
                React.createElement(ra_core_1.RecordsIterator, { data: data, render: function (record, rowIndex) { return (React.createElement(SimpleListItem_1.SimpleListItem, { key: record.id, rowIndex: rowIndex, linkType: linkType, rowClick: rowClick, rowSx: rowSx, rowStyle: rowStyle, resource: resource },
