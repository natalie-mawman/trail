 ...
 * );
 */
export var SimpleList = function (inProps) {
    ...
    return (React.createElement(WithListContext, __assign({}, props, { loading: React.createElement(SimpleListLoading, { className: className, hasLeftAvatarOrIcon: !!leftIcon || !!leftAvatar, hasRightAvatarOrIcon: !!rightIcon || !!rightAvatar, hasSecondaryText: !!secondaryText, hasTertiaryText: !!tertiaryText }), empty: empty !== null && empty !== void 0 ? empty : null, 
        // We need to keep passing data explicitly as it may have been passed down through props.
        render: function (_a) {
            var data = _a.data;
            return (React.createElement(Root, __assign({ className: className }, sanitizeListRestProps(rest)),
                React.createElement(RecordsIterator, { data: data, render: function (record, rowIndex) { return (React.createElement(SimpleListItem, { key: record.id, rowIndex: rowIndex, linkType: linkType, rowClick: rowClick, rowSx: rowSx, rowStyle: rowStyle, resource: resource },
