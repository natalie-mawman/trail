...
var Title_1 = require("../layout/Title.cjs");
var ListToolbar_1 = require("./ListToolbar.cjs");
var pagination_1 = require("./pagination/index.cjs");
var ListActions_1 = require("./ListActions.cjs");
var Empty_1 = require("./Empty.cjs");
...
var ListView = function (props) {
    var _a = props.actions, actions = _a === void 0 ? defaultActions : _a, aside = props.aside, filters = props.filters, emptyWhileLoading = props.emptyWhileLoading, _b = props.pagination, pagination = _b === void 0 ? defaultPagination : _b, children = props.children, className = props.className, _c = props.component, Content = _c === void 0 ? DefaultComponent : _c, title = props.title, _d = props.empty, empty = _d === void 0 ? defaultEmpty : _d, render = props.render, _e = props.offline, offline = _e === void 0 ? defaultOffline : _e, error = props.error, rest = __rest(props, ["actions", "aside", "filters", "emptyWhileLoading", "pagination", "children", "className", "component", "title", "empty", "render", "offline", "error"]);
    var listContext = (0, ra_core_1.useListContext)();
    var defaultTitle = listContext.defaultTitle, data = listContext.data, errorState = listContext.error, isPaused = listContext.isPaused, isPending = listContext.isPending, isPlaceholderData = listContext.isPlaceholderData, filterValues = listContext.filterValues, resource = listContext.resource, total = listContext.total, hasNextPage = listContext.hasNextPage, hasPreviousPage = listContext.hasPreviousPage;
    ...
    var renderList = function () {
        var _a;
        return (React.createElement("div", { className: (0, clsx_1.default)(exports.ListClasses.main, (_a = {},
                _a[exports.ListClasses.noActions] = !(filters || actions) || showOffline || showError,
                _a)) },
            filters || actions ? (React.createElement(ListToolbar_1.ListToolbar, { className: exports.ListClasses.actions, filters: filters, actions: actions })) : null,
            React.createElement(Content, { className: exports.ListClasses.content }, showOffline
                ? offline
                : showError
                    ? error
                    : render
    ...
    var shouldRenderEmptyPage = !errorState &&
...
var Root = (0, styles_1.styled)('div', {
    ...
    return (_b = {
        ...
        _b["& .".concat(exports.ListClasses.content)] = (_c = {
            ...
            _c.overflow = 'inherit',
            _c),
        _b["& .".concat(exports.ListClasses.noActions)] = {
            marginTop: '1em',
        },
