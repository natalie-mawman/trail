    ...
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement(Popover, { open: Boolean(anchorEl), anchorEl: anchorEl, onClose: handleClose, anchorOrigin: {
            ...
            React.createElement(Box, { component: "ul", sx: {
                    p: 1,
                    my: 0,
                } }, availableColumns.map(function (column) { return (React.createElement(FieldToggle, { key: column.index, source: column.source, label: column.label, index: column.index, selected: columns.includes(column.index), onToggle: handleToggle, onMove: handleMove })); })))));
};
