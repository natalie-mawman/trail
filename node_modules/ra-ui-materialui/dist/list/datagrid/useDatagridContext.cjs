...
var DatagridContext_1 = __importDefault(require("./DatagridContext.cjs"));
var defaults_js_1 = __importDefault(require("lodash/defaults.js"));
var useDatagridContext = function (props) {
    var context = (0, react_1.useContext)(DatagridContext_1.default);
    return (0, react_1.useMemo)(function () {
        return (0, defaults_js_1.default)({}, props != null ? { isRowExpandable: props.isRowExpandable } : {}, context);
    }, [context, props]);
};
